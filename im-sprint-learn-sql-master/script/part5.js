...
*/
const PART5_2_7 = `SELECT title, body, created_at
FROM content
...
*/
const PART5_2_8 = `SELECT user.name, content.title, content.body, content.created_at
FROM user
...
*/
const PART5_2_10 = `SELECT user.name, COUNT (content.title) AS ContentCount
FROM user
